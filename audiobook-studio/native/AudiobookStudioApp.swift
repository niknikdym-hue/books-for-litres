...
private enum StudioHelpTopic: String, CaseIterable, Identifiable {
    ...
    var explanation: String {
        ...
        case .pronunciation:
            return "Выделите сложное слово, выберите ударение и сохраните его. Studio применит исправление к книге и автоматически запомнит его в «Словаре ударений» для следующих книг. Если у слова несколько значений, словарь попросит выбрать основной вариант."
        case .narrators:
