...
**Government of Hong Kong, FBI и INTERPOL** — те же первичные материалы, перечисленные выше и ниже. Они используются не для создания «инструкции атаки», а для подтверждения принципиально важного факта: реальная имперсонация может складываться из нескольких каналов и технологий — обычного письма, видеоконференции, мессенджера, синтетического голоса или видео и последующих сообщений.

Предложенная в книге последовательность «вход → подтверждение легенды → перенос → изоляция → действие» является **авторской аналитической моделью**, а не официальной классификацией FBI, INTERPOL или полиции Гонконга.
...
**NIST SP 800-63-4, Digital Identity Guidelines**, финальная Revision 4, 2025 год. Руководство разводит identity proofing, authentication и federation как разные задачи цифровой идентичности.
https://pages.nist.gov/800-63-4/sp800-63.html

**NIST SP 800-63A-4, Identity Proofing and Enrollment.** Использованы положения о валидации identity evidence, защищённых каналах, forged media/digital injection и необходимости многослойных мер.
https://pages.nist.gov/800-63-4/sp800-63a.html

**NIST SP 800-63B-4, Authentication and Authenticator Management.** Использованы положения о факторах «know / have / are», authentication intent и phishing resistance. В частности, стандарт прямо указывает, что несколько экземпляров одного типа фактора не превращаются в разные факторы; биометрическая характеристика сама по себе не рассматривается как самостоятельный аутентификатор на AAL3 и используется вместе с физическим аутентификатором.
https://pages.nist.gov/800-63-4/sp800-63b.html

Книга **не** выдаёт NIST за бытовой стандарт для российских семей или компаний. Термин authorization используется в его общем смысле информационной безопасности и отдельно от NIST Authentication Assurance Levels.

## К интерлюдии «Когда фейк ничего не просит»

**NIST AI 100-4** и **C2PA 2.4** используются для различения detection, provenance и authenticity. Ключевой вывод книги: технически подтверждаемое происхождение актива и истинность утверждения внутри актива — разные вопросы.

C2PA определяет provenance как историю цифрового актива и его взаимодействий; authenticity — как набор криптографически проверяемых фактов о контенте. Стандарт предоставляет trust signals, а не универсальный вердикт истинности.
