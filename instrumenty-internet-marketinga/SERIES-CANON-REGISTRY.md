# SERIES CANON / PORTFOLIO REGISTRY — «Инструменты интернет-маркетинга»
...
- marketplace-specific operating systems — учитывать наличие отдельной серии «Маркетплейс для практиков»;
- MidJourney-specific production — учитывать отдельную серию «MidJourney для практиков»;
- service-specific sales/promotion systems — учитывать серию «Секреты продвижения услуг»;
- standalone AI/video territories — не поглощать автоматически только потому, что AI связан с marketing.
...
- reader problem;
- economic/decision significance;
- world-class knowledge gap or opportunity;
- strong practical outputs;
- Russia application;
- AI/free-substitute gap;
